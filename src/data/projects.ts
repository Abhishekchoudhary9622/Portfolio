...
export const projectsData: ProjectDetail[] = [
  ...
  },
  {
    slug: "vitty-llm",
    title: "Vitty LLM",
    subtitle: "LLM Fine-Tuning & Deployment Pipeline",
    featured: false,
    ...
    keyCapabilities: [
      "Custom dataset preparation, cleansing, and instruction-response pairing",
      "Parameter-efficient fine-tuning on open-weights Llama architectures",
      "GGUF 4-bit / 8-bit quantization for constrained memory footprints",
      "Local inference serving via Ollama for zero-cloud latency execution",
      "Reproducible data and conversion pipeline scripts",
    ],
    shortDescription:
      "A reproducible pipeline for curating domain-specific training data, fine-tuning open-weights Llama models, and converting weights to GGUF format for low-memory, local edge execution.",
    architectureSteps: [
