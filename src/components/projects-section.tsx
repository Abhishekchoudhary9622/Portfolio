  ...
  return (
    <section id="projects" className="py-24 border-t border-border/60 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14 rounded-3xl bg-background-subtle border border-border hover:border-accent-blue/40 transition-all p-6 sm:p-10 relative overflow-hidden group">
